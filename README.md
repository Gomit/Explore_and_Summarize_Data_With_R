...
setwd('/Users/merongoitom/Desktop/Nanodegree/DataAnalysisProjects/P4ExploreandSummarizeData/ProjectSubmission')
...
```{r Histogram Quality Visualization}
...
```{r alcohol vs. density & residual-sugar vs. density}
...
```{r Visualized boxplot: Chlorides}
...
### Additional visualization scatterplot with linear regression line
```{r Visualization scatterplot: Chlorides}
...
```{r Visualized boxplot: Volatile.acidity}
...
### Additional visualization scatterplot with linear regression line
```{r Visualization scatterplot: Volatile.acidity}
...
### Visualized boxplot alcohol amount and wine quality
```{r Visualized boxplot: Total.sulfur.dioxide}
...
### Additional visualization scatterplot with linear regression line
```{r Visualization scatterplot: Total.sulfur.dioxide}
